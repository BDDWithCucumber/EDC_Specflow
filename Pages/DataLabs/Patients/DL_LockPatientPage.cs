...
{
    public class DL_LockPatientPage
    {
        public static IControl SaveBtn {get { return SyncUtilities.FindVisibleElement(By.Id("PatientsFreezeLock_btnPatientAction"));}}
        public static IControl CancelBtn
        {
            get
            {
                if (IsInLockPatientsPage())
                {
        ...
        static bool IsInLockPatientsPage()
        {
            ...
            {
                return Control_PropertyUtilities.GetText(titleSpan).Equals("Lock Patients", StringComparison.InvariantCultureIgnoreCase);
            }
            return false;
        }
    }
