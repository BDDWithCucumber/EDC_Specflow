Feature: Labs_DL_Display of Lab Form Questions-Study update-All Changes_5
...
###publish the study that has by removing the Questions Category and Lionic Code in Lab Form1 and Lionic Code in Lab Form2 and publish the study  
Scenario: T09_Upload and Stage a Study which has major study changes
	...
	And I upload study "Import_Study1_RemovedQuestionsinLabfrom1and2.zip" with Label "Major4"
...
###publish the study that has by removing the Questions Category and Lionic Code in Lab Form1 and Subcategory in Lab Form2 and publish the study 
...
Scenario: T17_Verify the Lab report data is populated with all the latest Dictionary lab values
	 # When I click on "Save" button on "LabForm1" CRF.
	 # Then The CRF with data is saved and checked-in successfully.	 
	  When I open form "LabForm2" of event "Visit (Week 2)"
	  And I click "Checkout" button on "LabForm1" CRF.
	...
	Then I verify below "Autobuild Table:" table questions answer data status in the CRF.
	  ...
	  ###################Now add the Questions Category and LionicCode in Lab Form1 and publish the study 
Scenario: T18_Navigate to StudyManagement page
	When I select DataManagerPortal item "Study Administration" from drop down
	And I click Link "Study Management" In StudyAdministrationPage
	Then I see BreadCrumb "Study Management"
...
Scenario: T19_Upload and Stage a Study which has major study changes
	...
	And I click ActionPalette Item "Upload Study File" in "StudyVersionMgmtListActions" ActionPalette
	And I click browse button in upload study file page		
	And I upload study "Import_Study1_AddedtheRemovedQuestionsinLabForm1.zip" with Label "Major4"
	And I open study which has "Uploaded" status
	And I click ActionPalette Item "Stage" in "StudyVersionPropertiesActions" ActionPalette
	And I open study which has "Staged" status
	Then I see notes "Note: Major changes have been detected to the study design. Patient migration will be required." in StudyVersionPropertiesPage
...
Scenario: T21_Navigate to site and select patient after Site Changes
      Given I navigate to "Patients" tab from main menu.
      And I select the site "01-Site" from Sites dropdown.
      When I select the patient "01-PAT" from patients table.
      Then I see Patient details page for "01-PAT".
...
@ObjectiveEvidence @ReqIDUS67403.1
Scenario: T22_Verify the Lab report data before Site Changes
	 When I open form "LabForm1" of event "Visit (Week 2)"
	 And I click "Checkout" button on "LabForm1" CRF.
	 And I expand row "2" of table "Autobuild Table:"
	  Then I verify below "Autobuild Table:" table questions data in the CRF.	   	 
...
Scenario: T23_Verify the Lab report data before Site Changes
	 When I open form "LabForm2" of event "Visit (Week 2)"
	 And I click "Checkout" button on "LabForm1" CRF.
	 And I expand row "2" of table "Autobuild Table:"
	  Then I verify below "Autobuild Table:" table questions data in the CRF.	   	 
...
###After migration user should see the Questions Category and Lionic Code in Lab Form1
