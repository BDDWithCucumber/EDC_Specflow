...
Feature:Labs_ReassociatingRRValueswithGenderchanges_Duplicate 

US59252_US63247_DL: Re-associate Reference Range to a Patient Lab Value (Age & Gender change)_Item History
...
Scenario: 16_Expand the Visit (week2) event and open the LabForm2 form and update the data.
 ...
 #         | 2                                        | Reference Range ID | 1012            | Text             |  |
