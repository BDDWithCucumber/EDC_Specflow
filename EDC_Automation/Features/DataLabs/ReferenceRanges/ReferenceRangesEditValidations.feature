@F8164
Feature:ReferenceRangesEditValidations
      As a Sponsor,
...
#Feature No:F8164
#Feature Link: https://rally1.rallydev.com/#/244270786880d/detail/userstory/208812276484
...
@ObjectiveEvidence @ReqID:US45992.1
...
@ObjectiveEvidence @ReqID:US45992.1,US45992.7
Scenario: 05_Add a blank lab test reference range record and check the Not Applicable checkbox, then verify the error message displayed at field level
	When I click on "Edit" icon of the first record in ReferenceRangesPage
	And enter the below lab data in ReferenceRangesPage
	| StartDate | EndDate | Gender        | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeLowSet | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	|           |         | Not Specified | =             |            | Years        | =           |          | Years      |                      |                   |                       |                    | >                      | 44                  | <                       | 79                   | 1Unit |
...
@ObjectiveEvidence @ReqID:US45992.8
Scenario: 07_Add a new lab test reference range record with empty CriticalRange(Low), then verify the error message displayed at field level
	...
	And enter the below lab data in ReferenceRangesPage
	| StartDate  | EndDate    | Gender | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeLowSet | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	| 09/18/2016 | 09/18/2020 | Male   | >             | 10         | Years        | <           | 19       | Years      | >                    | 23                | <                     | 83                 |                        |                     | =                | 100                  | 1Unit |
	And I click on "Save" icon of the first record in ReferenceRangesPage
...
Scenario: 08_Add a new lab test reference range record with empty CriticalRange(High), then verify the error message displayed at field level
	...
	And enter the below lab data in ReferenceRangesPage
	| StartDate  | EndDate    | Gender | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeLowSet | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	| 09/18/2016 | 09/18/2020 | Male   | >             | 10         | Years        | <           | 19       | Years      | >                    | 23                | <                     | 83                 |                        | 20                  |                         |                      | 1Unit |
	And I click on "Save" icon of the first record in ReferenceRangesPage
...
Scenario: 09_Add a new lab test reference range record with empty CriticalRange(Low), then verify the error message displayed at field level
	...
	And enter the below lab data in ReferenceRangesPage
	| StartDate  | EndDate    | Gender | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeLowSet | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	| 09/18/2016 | 09/18/2020 | Male   | >             | 10         | Years        | <           | 19       | Years      |                      |                   | =              | 83                 | >                      | 50                  | <                       | 100                  | 1Unit |
	And I click on "Save" icon of the first record in ReferenceRangesPage
...
Scenario: 10_Add a new lab test reference range record with empty CriticalRange(High), then verify the error message displayed at field level
	...
	And enter the below lab data in ReferenceRangesPage
	| StartDate  | EndDate    | Gender | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeLowSet | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	| 09/18/2016 | 09/18/2020 | Male   | >             | 10         | Years        | <           | 19       | Years      |                      | 23                |                       |                    | >                      |                     | <                       | 79                   | 1Unit |
	And I click on "Save" icon of the first record in ReferenceRangesPage
	Then I see error message "Required" for column "NormalRangeHigh"	

@ObjectiveEvidence @ReqID:US45992.10
Scenario: 11_Add a new lab test reference range record with Negative FromAge, then verify the error message displayed
	...
	And I click on "Edit" icon of the first record in ReferenceRangesPage
	And enter the below lab data in ReferenceRangesPage
	| StartDate  | EndDate    | Gender | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	| 09/18/2016 | 09/18/2020 | Male   | >             | 10         | Years        | <           | 10       | Years      | >                    | 23                | <                     | 83                 | 20                     | <                       | 100                  | 1Unit |
	And I click on "Save" icon of the first record in ReferenceRangesPage
	Then I see error message "Cannot be less than From Age" for column "ToAge"

@ObjectiveEvidence @ReqID:US45992.2
Scenario: 12_Add a new lab test reference range record with Invalid date Format, then verify the error message displayed
	...
	| StartDate  | EndDate    | Gender        | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeLowSet | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	| 1234567    | 09/18/2020 | Female        | >             | 10         | Weeks        | <           | 20       | Weeks      | >                    | 20                | <                     | 100                | >                      | 10                  | <                       | 150                  | 1Unit |
	...
	| as  @&456  | 09/18/2020 | Male          | >             | 17         | Months       | <           | 19       | Months     | >                    | 23                | <                     | 86                 | >                      | 10                  | <                       | 100                  | 1Unit |
...
Scenario: 13_Add a new lab test reference range record with Invalid date Format, then verify the error message displayed
	...
	| StartDate  | EndDate     | Gender        | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeLowSet | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	| 09/18/2016 | 5678907     | Female        | >             | 10         | Weeks        | <           | 20       | Weeks      | >                    | 20                | <                     | 100                | >                      | 10                  | <                       | 150                  | 1Unit |
	| 09/18/2016 | $%^&*(      | Male          | >             | 10         | Days         | <           | 19       | Days       | >                    | 23                | <                     | 84                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | uhytfJUHY   | Not Specified | >             | 10         | Weeks        | <           | 19       | Weeks      | >                    | 23                | <                     | 85                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | asa!@&456   | Not Specified | >             | 10         | Weeks        | <           | 19       | Weeks      | >                    | 23                | <                     | 85                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | lk   !@#789 | Male          | >             | 10         | Months       | <           | 19       | Months     | >                    | 23                | <                     | 86                 | >                      | 10                  | <                       | 100                  | 1Unit |

@ObjectiveEvidence @ReqID:US45992.4
Scenario: 14_Add a new lab test reference range record with Invalid From Age and ToAge, then verify the error message displayed
	...
	| StartDate  | EndDate    | Gender        | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeLowSet | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	| 09/18/2016 | 09/18/2020 | Not Specified | >             | 11         | Years        | <           | 10       | Years      | >                    | 23                | <                     | 85                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Female        | >             | 1          | Years        | <           | 11       | Months     | >                    | 20                | <                     | 100                | >                      | 10                  | <                       | 150                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Female        | >             | 1          | Years        | <           | 51       | Weeks      | >                    | 20                | <                     | 100                | >                      | 10                  | <                       | 150                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Female        | >             | 1          | Years        | <           | 364      | Days       | >                    | 20                | <                     | 100                | >                      | 10                  | <                       | 150                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Male          | >             | 13         | Months       | <           | 1        | Years      | >                    | 23                | <                     | 84                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Male          | >             | 25         | Months       | <           | 2        | Years      | >                    | 23                | <                     | 84                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Male          | >             | 1          | Months       | <           | 3        | Weeks      | >                    | 23                | <                     | 84                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Male          | >             | 1          | Months       | <           | 29       | Days       | >                    | 23                | <                     | 84                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Male          | >             | 107        | Months       | <           | 106      | Months     | >                    | 23                | <                     | 86                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Not Specified | >             | 5          | Weeks        | <           | 1        | Months     | >                    | 23                | <                     | 85                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Not Specified | >             | 9          | Weeks        | <           | 2        | Months     | >                    | 23                | <                     | 85                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Not Specified | >             | 4          | Weeks        | <           | 29       | Days       | >                    | 23                | <                     | 85                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Female        | >             | 1000       | Weeks        | <           | 999      | Weeks      | >                    | 20                | <                     | 100                | >                      | 10                  | <                       | 150                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Male          | >             | 105        | Days         | <           | 104      | Days       | >                    | 23                | <                     | 84                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Male          | >             | 1          | Days         | <           | 23       | Hours      | >                    | 23                | <                     | 84                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Male          | >             | 2          | Hours        | <           | 1        | Hours      | >                    | 23                | <                     | 84                 | >                      | 10                  | <                       | 100                  | 1Unit |

@ObjectiveEvidence @ReqID:US45992.5
Scenario: 15_Add a new lab test reference range record with Invalid Normal Range(High), then verify the error message displayed
	...
	| StartDate  | EndDate    | Gender        | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeLowSet | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	| 09/18/2016 | 09/18/2020 | Not Specified | >             | 10         | Years        | <           | 11       | Years      | >                    | 100               | <                     | 99                 | >                      | 50                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Not Specified | >             | 10         | Years        | <           | 11       | Years      |                      | 100               |                       | 99                 | >                      | 50                  | <                       | 100                  | 1Unit |

@ObjectiveEvidence @ReqID:US45992.6
Scenario: 16_Add a new lab test reference range record with Invalid Critical Range(High), then verify the error message displayed
	...
	| StartDate  | EndDate    | Gender        | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeLowSet | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	| 09/18/2016 | 09/18/2020 | Not Specified | >             | 10         | Years        | <           | 11       | Years      | >                    | 20                | <                     | 50                 | >                      | 100                 | <                       | 99                   | 1Unit |
	| 09/18/2016 | 09/18/2020 | Not Specified | >             | 10         | Years        | <           | 11       | Years      | >                    | 20                | <                     | 50                 |                        | 100                 |                         | 99                   | 1Unit |

@ObjectiveEvidence @ReqID:US45992.1,US45992.9
Scenario: 17_Add a new lab test reference range record with Invalid date Format, then verify the error message displayed
	...
	And enter the below lab data in ReferenceRangesPage
	| StartDate | EndDate    | Gender | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeLowSet | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	| 1234567   | 09/18/2020 | Female | >             |            | Years        | <           |          | Years      | >                    | 20               | <                     | 100                | >                      | 10                  | <                       | 150                  | 1Unit |
	And I click on "Save" icon of the first record in ReferenceRangesPage
...
Scenario: 18_Add a new lab test reference range record with Invalid date Format, then verify the error message displayed
	...
	And enter the below lab data in ReferenceRangesPage
	| StartDate | EndDate    | Gender | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeLowSet | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	| 1234567   | 09/18/2020 | Female | >             | 20         | =            | <           | 30       | =          | >                    | 20                | <                     | 100                | >                      | 10                  | <                       | 150                  | 1Unit |
	And I click on "Save" icon of the first record in ReferenceRangesPage
...
Scenario: 19_Add a new lab test reference range record with Invalid date Format, then verify the error message displayed
	...
	And enter the below lab data in ReferenceRangesPage
	| StartDate | EndDate    | Gender | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeLowSet | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	| 1234567   | 09/18/2020 | Female | >             |            | =            | <           |          | =          | >                    | 20                | <                     | 100                | >                      | 10                  | <                       | 150                  | 1Unit |
	And I click on "Save" icon of the first record in ReferenceRangesPage
	Then I see error message "Required" for column "FromAge"	
	And I see error message "Required" for column "FromAgeUnitTypeKey"
	And I see error message "Required" for column "ToAge"
...
Scenario: 20_Add a new lab test reference range record with Invalid From Age and ToAge, then verify the error message displayed
	...
	| StartDate  | EndDate    | Gender        | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeLowSet | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	| 09/18/2016 | 09/18/2020 | Not Specified | =             | 10         | Years        | =           | 10       | Years      | >                    | 20                | <                     | 50                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Not Specified | >             | 10         | Years        | <           | 11       | Years      | >                    | 20                | <                     | 50                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Female        | >             | 1          | Years        | <           | 13       | Months     | >                    | 20                | <                     | 50                 | >                      | 10                  | <                       | 100                  | 1Unit |
	| 09/18/2016 | 09/18/2020 | Female        | >             | 1          | Years        | <           | 53       | Weeks      | >                    | 20                | <                     | 50                 | >                      | 10                  | <                       | 100                  | 1Unit |

@ObjectiveEvidence @ReqID:US45992.3
Scenario: 21_Add a new lab test reference range record with Invalid date Format, then verify the error message displayed
	...
	| StartDate  | EndDate    | Gender | FromAgeSelect | FromAgeSet | FromAgeRange | ToAgeSelect | ToAgeSet | ToAgeRange | NormalRangeLowSelect | NormalRangeLowSet | NormalRangeHighSelect | NormalRangeHighSet | CriticalRangeLowSelect | CriticalRangeLowSet | CriticalRangeHighSelect | CriticalRangeHighSet | Unit  |
	| 09/18/2016 | 09/18/2015 | Female | >             | 10         | Weeks        | <           | 20       | Weeks      | >                    | 20               | <                     | 100                | >                      | 10                  | <                       | 120                  | 1Unit |
	| 09/18/2016 | 08/18/2016 | Female | >             | 10         | Weeks        | <           | 20       | Weeks      | >                    | 20               | <                     | 100                | >                      | 10                  | <                       | 120                  | 1Unit |
	| 09/18/2016 | 09/17/2016 | Female | >             | 10         | Weeks        | <           | 20       | Weeks      | >                    | 20              | <                     | 100                | >                      | 10                  | <                       | 120                  | 1Unit |
