...
namespace Reports.Common
{
    public class MSWord
    {
        ...
        /*public Word.Document OpenResultDocTemplateNSave(string DocName, string SaveLocation)
        {
            ...
            Para.Range.Bold = 0;
            Para.Range.Text = "Description:     " + FeatureContext.Current.FeatureInfo.Description + " \n";
            Para.Range.Text = "Application Name: " + ConfigurationHelper.Application + "\n";
            Para.Range.Text = "Version: " + ConfigurationHelper.AppVersion + "\n";
            Para.Range.Text = "Environment: " + ConfigurationHelper.DataLabsURL + "\n\n";
            object Missing = System.Reflection.Missing.Value;
            object EndOfDoc = "\\endofdoc";
            Word.Table TableObj;
            Word.Range Range = Doc.Bookmarks.get_Item(ref EndOfDoc).Range;
