...
{
    public class BP_CRF_Comments_PagerUtilities
    {
        public static bool NavigateToFirstPage()
        {
            return ClickPageNavigationButton(DL_CRF_Comments_Pagination.FirstPageButton);
        }
        public static bool NavigateToPreviousPage()
        {
            return ClickPageNavigationButton(DL_CRF_Comments_Pagination.PreviousPageButton);
        }
        public static bool NavigateToNextPage()
        {
            return ClickPageNavigationButton(DL_CRF_Comments_Pagination.NextPageButton);
        }
        public static bool NavigateToLastPage()
        {
            return ClickPageNavigationButton(DL_CRF_Comments_Pagination.LastPageButton);
        }
