...
{
    public class BP_CRF_Workflow_PagerUtilities
    {
        public static bool NavigateToFirstPage()
        {
            return ClickPageNavigationButton(DL_CRF_Workflow_Pagination.FirstPageButton);
        }
        public static bool NavigateToPreviousPage()
        {
            return ClickPageNavigationButton(DL_CRF_Workflow_Pagination.PreviousPageButton);
        }
        public static bool NavigateToNextPage()
        {
            return ClickPageNavigationButton(DL_CRF_Workflow_Pagination.NextPageButton);
        }
        public static bool NavigateToLastPage()
        {
            return ClickPageNavigationButton(DL_CRF_Workflow_Pagination.LastPageButton);
        }
